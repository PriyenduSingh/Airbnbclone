    ...
    return (
        <div>
                ...
                <form onSubmit={savePlace}>
                    ...
                    <div className="grid mt-2 grid-cols-2 md:grid-cols-3">
                    ...
                    <p className="text-gray-500 text-sm">add check in and out times, remeber to have some time window for cleaning the room between the guests</p>
